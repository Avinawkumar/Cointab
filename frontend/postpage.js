...
async function fetchData() {
    try {
        ...
        let userResponse = await fetch(`https://successful-visor-fish.cyclic.app/user/${userId}`)
        let userData = await userResponse.json()

        let postResponse = await fetch(`https://successful-visor-fish.cyclic.app/post/checkUserId/${userId}`)
...
BulkAdd.addEventListener("click", async () => {
    try {
        let response = await fetch("https://successful-visor-fish.cyclic.app/post/bulkadd", {
            method: "POST",
            headers: {
