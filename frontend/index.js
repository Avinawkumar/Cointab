...
async function fetchData() {
    try {
        ...
        let userResponse = await fetch("https://successful-visor-fish.cyclic.app/user/get")
    ...
    jsonData.forEach(element => {
        ...
        if (userIDs.includes(element.id)) {
            ...
            toggleButton.addEventListener("click", async () => {
                try {
                    let response = await fetch("https://successful-visor-fish.cyclic.app/user/post", {
                        method: "POST",
                        headers: {
        ...
        tr.append(name, email, phone, website, city, company, action)
